...
class ModelActivity : Activity() {
     ...
     */
    val backgroundColor = floatArrayOf(0f, 0f, 0f, 0f)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (b != null) {
            ...
            } catch (ex: Exception) { // Assuming default background color
            }
        }
...
// as the ContentView for this Activity.
    ...
    private fun setupActionBar() { // if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
...
// }
    ...
    private fun setupOnSystemVisibilityChangeListener() {
        ...
        window.decorView.setOnSystemUiVisibilityChangeListener { visibility: Int ->
            ...
            if (visibility and View.SYSTEM_UI_FLAG_FULLSCREEN == 0) { // The system bars are visible. Make any desired
                hideSystemUIDelayed()
            }
        }
    }
    ...
    private fun hideSystemUIKitKat() { // Set the IMMERSIVE flag.
